<div class="u-devices-v2" style="background-image:url('/assets/img/rakwireless/nasa-53884-unsplash.jpg');background-size:cover;background-attachment:fixed;">
      <div class="container space-1 space-md-2 position-relative z-index-2">
        <!-- Title -->
        <div class="w-md-80 w-lg-50 text-center mx-md-auto">
          
          <h2 class="h1 text-white"><span class="font-weight-semi-bold">We're building up</span> an Enterprise Initiative</h2>
