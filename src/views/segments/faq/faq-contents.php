      ...
      <div class="row">
        <div id="stickyBlockStartPoint" class="col-lg-3 mb-7 mb-lg-0">
          ...
          <nav class="js-sticky-block card border-0 bg-primary"
            ...
            <ul class="js-scroll-nav list-group list-group-transparent list-group-white list-group-flush list-group-borderless py-3 px-5">
              ...
              <li>
                <a class="list-group-item list-group-item-action py-3" href="#syncing">Syncing</a>
              </li>
              <li>
                <a class="list-group-item list-group-item-action py-3" href="#account">Account</a>
              </li>
              <li>
                <a class="list-group-item list-group-item-action py-3" href="#privacy">Privacy</a>
              </li>
            </ul>
          </nav>
          <!-- End Nav -->
        ...
        <div class="col-lg-9">
          ...
          <div id="syncing" class="space-2">
            <!-- Title -->
            <div class="mb-3">
              <h3 class="text-primary font-weight-semi-bold">Syncing</h3>
            </div>
            <!-- End Title -->
          ...
          <div id="account" class="space-2">
            <!-- Title -->
            <div class="mb-3">
              <h3 class="text-primary font-weight-semi-bold">Account</h3>
            </div>
            <!-- End Title -->
          ...
          <div id="privacy" class="space-top-2">
            <!-- Title -->
            <div class="mb-3">
              <h3 class="text-primary font-weight-semi-bold">Privacy</h3>
            </div>
            <!-- End Title -->
