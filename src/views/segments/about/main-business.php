...
<div class="container space-1">
    <h2 class="text-primary mx-auto mw-mc mb-6"><strong class="font-weight-semi-bold">Main Business</strong></h2>
        ...
        <div class="col-sm-6 offset-sm-3 col-lg-4 offset-lg-0 mb-9 mb-lg-0">
            ...
            <div class="text-center px-lg-5">
                <figure id="icon12" class="svg-preloader ie-height-72 max-width-10 mx-auto mb-3">
                    <img class="js-svg-injector" src="../../assets/svg/icons/icon-12.svg" alt="SVG" data-parent="#icon12">
                </figure>
        ...
        <div class="col-sm-6 col-lg-4 mb-9 mb-lg-0">
            ...
            <div class="text-center px-lg-5">
                <figure id="icon10" class="svg-preloader ie-height-72 max-width-10 mx-auto mb-3">
                    <img class="js-svg-injector" src="../../assets/svg/icons/icon-10.svg" alt="SVG" data-parent="#icon10">
                </figure>
        ...
        <div class="col-sm-6 col-lg-4">
            ...
            <div class="text-center px-lg-5">
                <figure id="icon11" class="svg-preloader ie-height-72 max-width-10 mx-auto mb-3">
                    <img class="js-svg-injector" src="../../assets/svg/icons/icon-11.svg" alt="SVG" data-parent="#icon11">
                </figure>
