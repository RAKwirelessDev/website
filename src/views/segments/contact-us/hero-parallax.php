    ...
    <div class="d-lg-flex">
        <div class="container d-lg-flex align-items-lg-center position-relative space-2 space-top-md-5 space-bottom-4 z-index-2">
            ...
            <div class="w-lg-80 text-center mx-auto">
                <h1 class="display-4 font-size-md-down-5 text-white font-weight-semi-bold mb-0">Got a question?</h1>
                <p class="lead text-white mb-0">We'd love to talk about how we can help you.</p>
            </div>
            <!-- End Content -->
